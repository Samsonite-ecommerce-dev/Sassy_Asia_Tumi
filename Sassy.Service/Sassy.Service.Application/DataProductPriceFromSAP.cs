...
{
    public class DataProductPriceFromSAP : IModule
    {
        private IApplicationService _applicationService;
        private ISAPService _sAPService;
        private appEntities _appDB;
        public DataProductPriceFromSAP(IApplicationService applicationService, ISAPService sAPService, appEntities appEntities)
        {
        ...
        public void Init()
        {
            ...
            {
                //读取配置
                serviceConfig = _applicationService.InitService<DataProductPriceFromSAP>();
        ...
        {
            /***********下载产品价格数据***************/
            string _msg = DownProductPriceDataFromSAP();
            /***************************************/
        ...
        /// 下载产品价格数据
        /// </summary>
        private string DownProductPriceDataFromSAP()
        {
            List<string> _msgList = new List<string>();
            FileLogHelper.WriteLog($"Start to download sparepart price from SAP.", baseModel.ThreadName);
            //保存产品
            var _result = _sAPService.DownSparePartPrice();
            //记录结果
