...
namespace Samsonite.Library.Core
{
    public class ServiceLogService : IServiceLogService
    {
        ...
        private void InsertLog(object data, int logType, ServiceLogLeave logLeave)
        {
            _logDB.ServiceLog.Add(new ServiceLog
            {
                LogType = logType,
                LogLevel = (int)logLeave,
        ...
        public void Debug(object message, int serviceId) {
            InsertLog(message, serviceId, ServiceLogLeave.Debug);
        }
        ...
        {
            InsertLog(message, serviceId, ServiceLogLeave.Warn);
        }
        ...
        {
            InsertLog(message, serviceId, ServiceLogLeave.Info);
        }
        ...
        {
            InsertLog(message, serviceId, ServiceLogLeave.Error);
        }
    }

    //<!--(高) OFF > FATAL > ERROR > WARN > INFO > DEBUG > ALL(低) -->
    public enum ServiceLogLeave
    {
        All,
        Info,
        Warn,
