...
namespace Samsonite.Library.Core.WorkService
{
    ...
    public class ApplicationService : IApplicationService
    {
        ...
        public BaseModel InitBase<T>()
        {
            ...
            {
                //10秒检测一次
                LoopTime = GlobalConfig.ThreadIntervalTime,
                CurrentErrorTimes = 0,
                MaxErrorTimes = GlobalConfig.MaxErrorTimes,
                AssemblyName = _assemblyName,
                ThreadName = $"{GlobalConfig.ThreadPrefix}_thread_{_assemblyName}",
